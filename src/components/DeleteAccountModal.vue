    ...
    >
      ...
      >
        ...
        <p class="text-[var(--color-text-muted)] mb-6">
          Möchtest du deinen Account wirklich unwiderruflich löschen? Alle deine Daten und
          Postkarten gehen damit verloren.
        </p>

        <div class="flex justify-end gap-3">
          <Button variant="ghost" @click="close"> Abbrechen </Button>
