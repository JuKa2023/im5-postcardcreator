                    ...
                    <div class="absolute inset-0 z-20 overflow-hidden">
                      ...
                      >
                        ...
                        <span
                          ...
                          :style="{ fontSize: element.fontSize ? `${element.fontSize}px` : '4rem' }"
                        >
                          {{ element.content }}
                        </span>
                        <img
                        ...
                        >
                          <button
                            @click="onChangeFont"
                            class="p-1 hover:bg-gray-100 rounded font-serif text-lg"
                          >
                            Aa
                          </button>
                          <button
                            @click="toggleBold"
                            class="p-1 hover:bg-gray-100 rounded font-bold"
                          >
                            B
                          </button>
                          <button
                            @click="toggleItalic"
                            class="p-1 hover:bg-gray-100 rounded italic"
                          >
                            I
                          </button>
                          <input
                            ...
                            "
                            @input="updateColor"
                            class="w-6 h-6 cursor-pointer border-none p-0"
                          />
                          <button
      ...
      >
        <div class="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto">
          <div class="flex justify-between items-center mb-4">
            ...
            <button @click="showMoodGallery = false" class="text-gray-500 hover:text-gray-700">
              ✕
            </button>
          </div>
...
const onDrag = (event: MouseEvent) => {
  ...
  const containerWidth = isVertical.value ? 256 : 384
